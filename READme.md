...
The application is deployed using a production-style architecture consisting of a React frontend, FastAPI backend, Docker containers, Nginx reverse proxy, and AWS EC2. GitHub actions was used to make CI/CD pipelines.
